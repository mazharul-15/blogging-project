<?php 
  ...
  //requesting all
  $post = $obj->display_published_post();
?>
                  ...
                  <div class="col-lg-12">
                    <div class="blog-post">
                      <div class="blog-thumb">
                        <img src="upload/<?php echo $postdata['post_img']; ?>" alt="post pic">
                      </div>
                      <div class="down-content">
                        <span><?php echo $postdata['cat_name']; ?></span>
                        <a href="single_post.php?view=post_view&&id=<?php echo $postdata['post_id']; ?>"><h4><?php echo $postdata['post_title']; ?></h4></a>
                        <ul class="post-info">
